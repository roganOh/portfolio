...
DIMS = ['ga:date', 'ga:yearMonth', 'ga:yearWeek','ga:country']
METRICS = ['ga:newUsers', 'ga:pageviews', 'ga:sessions', 'ga:users', 'ga:visitors']
locate = 'ga_web/with_country'
...
dag = DAG(
    dag_id='ga_web_with_country_snowflake',
...
query = ['Alter warehouse airflow_warehouse resume if suspended;',
         'remove @ga_web.%with_country;',
         'Alter warehouse airflow_warehouse resume if suspended;',
         'truncate table ga_web.with_country;',
         'Alter warehouse airflow_warehouse resume if suspended;',
         'put file:///home/ec2-user/airflow/csv_files/ga_web/with_country.tsv @ga_web.%with_country;',
         'Alter warehouse airflow_warehouse resume if suspended;',
         '''copy into airflow_database.ga_web.with_country from @AIRFLOW_DATABASE.ga_web.%with_country
